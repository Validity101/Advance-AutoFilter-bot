...
PICS = (environ.get('PICS', 'https://graph.org/file/6256a0a30a2199d7c1d46-19a8b708b3410d422f.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7289855833').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002158286572').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002449677578') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002561114141')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002587937184')
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'TgCollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+VpSZYmHhr4dmYzk1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/KdramaTalkies')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'KdramaTalkies') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Nkkwksl')
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/VEriwfy/36')
...
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', '1ab8f9226671c3ea4da75be8c6f6ac012e0a9a09')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/VEriwfy/36') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
...
MSG_ALRT = environ.get('MSG_ALRT', 'Keep Growing Mate')
